...
# Estimate transformation matrix (Do coregistration into b0 from T2)
flirt -in $T2FLAIR -ref ../b0_dwi.nii.gz -out co_T2_b0.nii.gz -omat co_T2_b0.mat -bins 256 -cost corratio -searchrx -90 90 -searchry -90 90 -searchrz -90 90 -dof 12 -interp trilinear
...
flirt -in $Lesion_mask -ref ../b0_dwi.nii.gz -out co_Lesion_mask_alignb0.nii.gz -applyxfm -init co_T2_b0.mat -interp nearestneighbour
flirt -in co_Lesion_mask_alignb0.nii.gz -ref $dtitktensor -out co_Lesion_mask.nii.gz -applyxfm -init $trans_matrix -interp nearestneighbour
...
affineScalarVolume -in co_Lesion_mask.nii.gz -out co_Lesion_mask_to_targ.nii.gz -trans $tptotargaff -target $dttprefnii -interp 1
